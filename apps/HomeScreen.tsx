            ...
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <AppCard
                    ...
                    icon={
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M20 7L10 7L4 15L14 15L20 7z" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M14 7L8 15" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M6 3v4M4 5h4" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M19 15v4M17 17h4" />
                        </svg>
                    }
                ...
                />
                 <AppCard
                    ...
                    onClick={() => onSelectApp('imageupscaling')}
                    supportedMedia="AI"
                />
                 <AppCard 
